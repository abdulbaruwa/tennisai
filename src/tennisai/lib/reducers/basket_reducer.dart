...
final basketReducer = combineReducers<List<Basket>>([
  ...
  new TypedReducer<List<Basket>, AddTournamentToBasketAction>(_addTournamentToBasket),
  new TypedReducer<List<Basket>, RemoveTournamentFromBasketAction>(_removeTournamentFromBasket),
