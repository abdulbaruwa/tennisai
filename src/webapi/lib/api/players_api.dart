...
class PlayersApi {
  ...
  ///
  /// 
  Future<EnteredTournaments> enteredTournaments(String playerId) async {
    ...
    // create path and map variables
    String path = "/api/Players/{playerId}/enteredtournaments".replaceAll("{format}","json").replaceAll("{" + "playerId" + "}", playerId.toString());
  ...
  ///
  /// 
  Future<Player> playerProfile(String playerId) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/api/Players/{playerId}/playerprofile".replaceAll("{format}","json").replaceAll("{" + "playerId" + "}", playerId.toString());
  ...
  ///
  /// 
  Future<WatchedTournaments> watchedTournaments(String playerId) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/api/Players/{playerId}/watchedtournaments".replaceAll("{format}","json").replaceAll("{" + "playerId" + "}", playerId.toString());
