...
final dashboardReducer = combineTypedReducers<List<Tournament>>([
  ...
  new ReducerBinding<List<Tournament>, RemoveFromWatchedTournamentsAction>(_removeFromWatchedTournaments),
...
List<Tournament> _removeFromWatchedTournaments(List<Tournament> watchedTournaments, RemoveFromWatchedTournamentsAction action){
  return watchedTournaments.where((watchedTournament) => watchedTournament.code != action.tournamentCode).toList();
  }
